    ...
    <section id="nosotros" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Misión */}
          <div
            className="bg-white p-12 rounded-[2.5rem] border border-brand-green/10 hover:border-brand-green/20 hover:shadow-lg transition-all duration-500 group"
            data-aos="fade-up"
          >
            <div className="w-16 h-16 bg-brand-light rounded-2xl flex items-center justify-center text-brand-green mb-8 group-hover:bg-brand-green group-hover:text-white transition-all duration-300">
          ...
          {/* Visión */}
          <div
            className="bg-brand-light/40 p-12 rounded-[2.5rem] border border-brand-green/10 hover:border-brand-green/20 hover:shadow-lg transition-all duration-500 group"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-brand-green mb-8 shadow-sm group-hover:bg-brand-green group-hover:text-white transition-all duration-300">
